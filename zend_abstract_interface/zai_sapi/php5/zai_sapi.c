...
void (*register_custom_server_variables)(zval *track_vars_server_array TSRMLS_DC) = NULL;

static void zs_register_variables(zval *track_vars_array TSRMLS_DC) {
    php_import_environment_variables(track_vars_array TSRMLS_CC);
    if (register_custom_server_variables) {
        register_custom_server_variables(track_vars_array TSRMLS_CC);
    }
}
